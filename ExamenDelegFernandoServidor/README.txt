...
a persistence unit "ExamenDelegFernandoServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenDelegFernandoServidor\pom.xml":
...
artifact ("ExamenDelegFernandoServidor.war") is already built. You can build
