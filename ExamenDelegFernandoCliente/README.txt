...
a persistence unit "ExamenDelegFernandoClientePersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenDelegFernandoCliente\pom.xml":
...
artifact ("ExamenDelegFernandoCliente.war") is already built. You can build
